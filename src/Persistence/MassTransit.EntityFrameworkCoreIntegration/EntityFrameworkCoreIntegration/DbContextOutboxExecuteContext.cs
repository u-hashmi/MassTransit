...
namespace MassTransit.EntityFrameworkCoreIntegration
{
    ...
    public class DbContextOutboxExecuteContext<TDbContext, TArguments> :
        ExecuteContextProxy<TArguments>,
        OutboxExecuteContext<TArguments>,
        ...
        where TArguments : class
    {
        ...
        public DbContextOutboxExecuteContext(ExecuteContext<TArguments> context, OutboxConsumeOptions options, IServiceProvider provider,
