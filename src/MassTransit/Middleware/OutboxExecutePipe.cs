...
namespace MassTransit.Middleware
{
    ...
    public class OutboxExecutePipe<TArguments> :
        IPipe<OutboxExecuteContext<TArguments>>
        where TArguments : class
    {
        readonly IPipe<ExecuteContext<TArguments>> _next;
        readonly OutboxConsumeOptions _options;
        readonly IExecuteScopeContext<TArguments> _scopeContext;

        public OutboxExecutePipe(OutboxConsumeOptions options, IExecuteScopeContext<TArguments> scopeContext, IPipe<ExecuteContext<TArguments>> next)
        {
            _options = options;
        ...
        public async Task Send(OutboxExecuteContext<TArguments> context)
        {
