...
namespace MassTransit.Middleware
{
    ...
    public class OutboxCompensatePipe<TLog> :
        IPipe<OutboxCompensateContext<TLog>>
        where TLog : class
    {
        readonly IPipe<CompensateContext<TLog>> _next;
        readonly OutboxConsumeOptions _options;
        readonly ICompensateScopeContext<TLog> _scopeContext;

        public OutboxCompensatePipe(OutboxConsumeOptions options, ICompensateScopeContext<TLog> scopeContext, IPipe<CompensateContext<TLog>> next)
        {
            _options = options;
        ...
        public async Task Send(OutboxCompensateContext<TLog> context)
        {
